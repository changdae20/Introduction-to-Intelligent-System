...
class OdometryNode:
    ...
    def __init__(self):
        ...
        rospy.Subscriber('/vesc/low_level/ackermann_cmd_mux/output', AckermannDriveStamped, self.cmd_callback)
    ...
    def cmd_callback(self, data):
        ...
        self.current_angular_velocity = data.drive.speed * math.tan(data.drive.steering_angle) / 1.02    #0.325 bigger than 1 , smaller than 1.1
